...
const updatedProduct = {name:"updates name", description: "updated description"}
...
describe("Product Controller Get", () => {
    ...
    it("should handle error", async () => {
        const errorMessage = { massage: "Error finding product data"}
        const rejectedPromise = Promise.reject(errorMessage)
    })
})
...
describe("Product Controller Update", () => {
    ...
    it("should handle 404 when item doesnt exist", async () => {
        productModel.findOneAndUpdate.mockReturnValue(null);
        await productController.updateProduct(req, res, next);
        expect(res.statusCode).toBe(404);
        expect(res._isEndCalled()).toBeTruthy();
    })
...
describe("Product Controller Delete", () => {
    ...
    it("should call ProductMode.findByIdAndDelete", async () => {
        req.params.productId = productId;
